        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="p-8">
              ...
              <h3 className="font-serif text-3xl font-bold mb-2">{experiences?.length || 0}+</h3>
            ...
            <div className="p-8">
              ...
              <h3 className="font-serif text-3xl font-bold mb-2">{featuredProjects?.length || 0}+</h3>
              <p className="text-muted-foreground">
            ...
            <div className="p-8">
              ...
              <h3 className="font-serif text-3xl font-bold mb-2">{featuredPosts?.length || 0}+</h3>
              <p className="text-muted-foreground">
